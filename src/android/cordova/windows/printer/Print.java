...
public class Print {
  public static void init(String[] args) throws IOException {
    ...
    System.out.println("Sorry you did not specify the aguments: ");
        
  }
  }

  // List names of all PrintServices that can support the attributes
  public static queryServices(PrintRequestAttributeSet attributes) {
  ...
  public static printToService(PrintService service, String filename,
  ...
  public static void printString(String str) throws PrintException, IOException {
    ...
    InputStream is = new ByteArrayInputStream(str +"\f".getBytes("UTF8"));
